...
Kapitelfolie: (~1 min)
- Übergang von Linting zu Architektur bereits in den Notizen abgedeckt

Slide 1: Container- und Präsentationskomponenten – Grundprinzip (~2 min)
- Visualisierung: ein Container, eine Präsentationskomponente
- Props ↓ / Events ↑
- Eine Komponente = eine klare Verantwortung

Slide 2: Container- und Präsentationskomponenten – In der Praxis (~2 min)
- Visualisierung: realistischer Komponentenbaum (farblich nach Typ)
- Das Prinzip skaliert: gleiche Regel, egal ob 1 oder 20 Komponenten
- Container können auch Kinder-Container haben

Slide 3: State-Typen (~2.5 min)
- Lokaler State vs. geteilter State vs. Server-State
- Weniger implizite Kopplung, weniger Seiteneffekte

Slide 4: Projektstruktur & Wiederverwendung (~2.5 min)
- Visualisierung: by-type vs. by-feature Dateibaum
- Nach Features oder Domänen strukturieren statt nach Dateitypen
- Klare Grenzen zwischen Screens, Features und Shared Components

Slide 5: Architektur im Alltag (~1.5 min)
- Architektur zeigt sich in Reviews, Refactorings und beim Einstieg
- Gute Struktur macht Tests, Accessibility und Design-Systeme leichter
- Übergang: Qualität endet nicht im Code, sondern auch in der Nutzung
-->
